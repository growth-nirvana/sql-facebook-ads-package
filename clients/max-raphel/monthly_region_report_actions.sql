-- monthly_region_report_actions
-- Batch-based monthly snapshot table for Facebook Ads Region Insights Actions (Ad level)
...
{% assign target_table_name = 'monthly_region_report_actions' %}
...
BEGIN TRANSACTION;
  ...
  INSERT INTO `{{target_dataset_id}}.{{target_table_name}}` (
    ...
    action_type, value, inline, _7_d_click, _1_d_view, region, tenant
  )
  SELECT
