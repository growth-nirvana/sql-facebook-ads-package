-- monthly_gender_report
-- Batch-based monthly snapshot table for Facebook Ads Gender Insights (Ad level)
...
{% assign target_table_name = 'monthly_gender_report' %}
...
BEGIN TRANSACTION;
  ...
  INSERT INTO `{{target_dataset_id}}.{{target_table_name}}` (
    ad_id, date, _gn_id, _gn_synced, account_id, clicks, impressions, spend, gender, tenant
  )
  SELECT
