-- monthly_device_report_actions
-- Batch-based monthly snapshot table for Facebook Ads Device Insights Actions (Ad level)
{% assign source_dataset_id = vars.source_dataset_id %}
{% assign target_dataset_id = vars.target_dataset_id %}
{% assign source_table_name = 'adsinsights_monthly_device_report_ad_level' %}
{% assign target_table_name = 'monthly_device_report_actions' %}
