-- daily_publisher_platform_account_report_actions
-- Batch-based pivoted actions table for Facebook Ads Daily Publisher Platform Account Insights
...
{% assign target_table_name = 'daily_publisher_platform_account_report_actions' %}
