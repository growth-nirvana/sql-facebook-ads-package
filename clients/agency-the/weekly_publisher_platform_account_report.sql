-- weekly_publisher_platform_account_report
-- Batch-based weekly snapshot table for Facebook Ads Weekly Publisher Platform Account Insights
...
{% assign target_table_name = 'weekly_publisher_platform_account_report' %}
