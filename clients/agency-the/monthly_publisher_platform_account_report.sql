-- monthly_publisher_platform_account_report
-- Batch-based monthly snapshot table for Facebook Ads Monthly Publisher Platform Account Insights
...
{% assign target_table_name = 'monthly_publisher_platform_account_report' %}
