-- monthly_publisher_platform_account_report_actions
-- Batch-based pivoted actions table for Facebook Ads Monthly Publisher Platform Account Insights
{% assign source_dataset_id = vars.source_dataset_id %}
{% assign target_dataset_id = vars.target_dataset_id %}
{% assign source_table_name = 'adsinsights_monthly_publisher_platform_account_insights' %}
{% assign target_table_name = 'monthly_publisher_platform_account_report_actions' %}
