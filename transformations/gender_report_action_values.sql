-- gender_report_action_values
-- Batch-based pivoted action values table for Facebook Ads Gender Insights
...
{% assign target_table_name = 'gender_report_action_values' %}
