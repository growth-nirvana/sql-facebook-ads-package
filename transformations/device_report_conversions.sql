-- device_report_conversions
-- Batch-based daily snapshot table for Facebook Ads Device Insights Conversions
...
{% assign target_table_name = 'device_report_conversions' %}
