-- device_report_action_values
-- Batch-based daily snapshot table for Facebook Ads Device Insights Action Values
...
{% assign target_table_name = 'device_report_action_values' %}
