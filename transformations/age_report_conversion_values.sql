-- age_report_conversion_values
-- Batch-based pivoted conversion values table for Facebook Ads Age Insights
...
{% assign target_table_name = 'age_report_conversion_values' %}
