-- platform_report_conversion_values
-- Batch-based pivoted conversion values table for Facebook Ads Platform Insights
...
{% assign target_table_name = 'platform_report_conversion_values' %}
