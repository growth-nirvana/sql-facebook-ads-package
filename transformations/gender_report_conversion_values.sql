-- gender_report_conversion_values
-- Batch-based pivoted conversion values table for Facebook Ads Gender Insights
...
{% assign target_table_name = 'gender_report_conversion_values' %}
