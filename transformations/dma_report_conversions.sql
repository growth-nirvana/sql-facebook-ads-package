-- dma_report_conversions
-- Batch-based pivoted conversions table for Facebook Ads DMA Insights
...
{% assign target_table_name = 'dma_report_conversions' %}
...
BEGIN TRANSACTION;
  ...
  FROM latest_batch
  , UNNEST(JSON_EXTRACT_ARRAY(conversions)) AS action
