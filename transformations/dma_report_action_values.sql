-- dma_report_action_values
-- Batch-based pivoted action_values table for Facebook Ads DMA Insights
{% assign source_dataset_id = vars.source_dataset_id %}
{% assign target_dataset_id = vars.target_dataset_id %}
{% assign source_table_name = 'adsinsights_dma_report' %}
{% assign target_table_name = 'dma_report_action_values' %}
...
BEGIN TRANSACTION;
  ...
  SELECT
    ...
    SAFE_CAST(dma AS STRING) AS dma,
