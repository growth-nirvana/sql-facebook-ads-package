-- ad_report_action_values
-- Batch-based pivoted action_values table for Facebook Ads Insights with replace strategy
...
{% assign target_table_name = 'ad_report_action_values' %}
