-- monthly_campaign_insights_actions
-- Batch-based pivoted actions table for Facebook Ads Monthly Campaign Insights with replace strategy
...
{% assign target_table_name = 'monthly_campaign_report_actions' %}
