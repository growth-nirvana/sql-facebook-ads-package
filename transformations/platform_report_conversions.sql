-- platform_report_conversions
-- Batch-based pivoted conversions table for Facebook Ads Platform Insights
...
{% assign target_table_name = 'platform_report_conversions' %}
