-- ad_report_conversions
-- Batch-based pivoted conversions table for Facebook Ads Insights with replace strategy
...
{% assign target_table_name = 'ad_report_conversions' %}
