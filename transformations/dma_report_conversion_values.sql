-- dma_report_conversion_values
-- Batch-based pivoted conversion_values table for Facebook Ads DMA Insights
...
{% assign target_table_name = 'dma_report_conversion_values' %}
