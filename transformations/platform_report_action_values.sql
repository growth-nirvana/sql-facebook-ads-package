-- platform_report_action_values
-- Batch-based pivoted action values table for Facebook Ads Platform Insights
...
{% assign target_table_name = 'platform_report_action_values' %}
