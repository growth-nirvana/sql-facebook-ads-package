-- gender_report_conversions
-- Batch-based pivoted conversions table for Facebook Ads Gender Insights
{% assign source_dataset_id = vars.source_dataset_id %}
{% assign target_dataset_id = vars.target_dataset_id %}
{% assign source_table_name = 'adsinsights_gender_report' %}
{% assign target_table_name = 'gender_report_conversions' %}
